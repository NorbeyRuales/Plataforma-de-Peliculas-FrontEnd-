...
const Switch: React.FC<Props> = ({ size = 22, className }) => {
  ...
  return (
    <StyledWrapper className={className} style={style}>
      <label className="theme-switch" aria-label="Cambiar tema" role="switch" aria-checked={checked}>
        <input
          type="checkbox"
...
const StyledWrapper = styled.div`
  ...
  /* Oculta de forma robusta el checkbox */
  ...
  .theme-switch__stars-container {
    position: absolute; color: var(--stars-color); top: -100%; left: 0.312em; width: 2.75em;
    transition: var(--transition);
  }
